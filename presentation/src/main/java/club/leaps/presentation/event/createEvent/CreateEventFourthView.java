...
public class CreateEventFourthView extends BaseView<EmptyPresenter> {
        ...
        frequencyRL.setOnClickListener(v -> {
            ...
            dailyTV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    frequency.setText(getString(R.string.time_stamp_daily));
                    weekRL.setVisibility(View.GONE);
                    dailyRL.setVisibility(View.VISIBLE);
            ...
            weeklyTV.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    frequency.setText(getString(R.string.time_stamp_weekly));
        ...
        dailyAdd();
            ...
            mDayStartOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
                    ...
                    endTimeDialog.setTitle(getString(R.string.end_time));
                    endTimeDialog.show();
                    }
                ...
                mDayEndOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int endHourOfDay, int endMinute) {
                        ...
                        if (!checktimings(stringDate, endTime)) {
                            Toast.makeText(getContext(), getString(R.string.schedule_events), Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    private void startDateAndTime() {
        startRL.setOnClickListener(v -> {
                ...
                startDateDialog.setTitle(getString(R.string.start_date));
        ...
        mStartDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                startTimeDialog.setTitle(getString(R.string.start_time));
        ...
        endRL.setOnClickListener(v -> {
            if (!repeat) {
                if(eventStartTime != null) {
                    ...
                    Toast.makeText(getContext(), getString(R.string.start_date_request), Toast.LENGTH_SHORT).show();
                }
            } else {
                if(eventStartDate != null) {
                    ...
                    endDateDialog.setTitle(getString(R.string.end_date));
                    endDateDialog.show();
                }
                else {
                    Toast.makeText(getContext(), getString(R.string.start_date_request), Toast.LENGTH_SHORT).show();
        ...
        mEndDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                if (eventStartDate.after(eventEndDate)) {
                    Toast.makeText(getContext(), getString(R.string.end_date_request), Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void dailyAdd() {
        ...
        helper.attachToRecyclerView(dayRV);
                ...
                if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                    ...
                    if (dX < 0) {
                       ...
                       /* icon = BitmapFactory.decodeResource(getResources(), R.drawable.close_red_btn);
                        ...
                        c.drawText(getString(R.string.delete),x,y,p2);
