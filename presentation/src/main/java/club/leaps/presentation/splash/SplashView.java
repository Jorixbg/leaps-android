...
import static club.leaps.presentation.splash.WalkthroughContainerView.MY_PERMISSIONS_REQUEST_LOCATION;
...
public class SplashView extends BaseView<SplashPresenter> implements InsideView {
                ...
                new AlertDialog.Builder(getContext())
                        ...
                        .setPositiveButton(R.string.ok, (dialogInterface, i) -> {
                            ...
                            ActivityCompat.requestPermissions(getActivity(),
                                    ...
                                    WalkthroughContainerView.MY_PERMISSIONS_REQUEST_LOCATION);
                        })
                        .create()
                        .show();
            } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode) {
            case WalkthroughContainerView.MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    openFragment(HomeScreenView.class, userid, true);
                }
            }
        }
    }
