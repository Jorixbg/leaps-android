package club.leaps.presentation.comment;
...
import club.leaps.networking.test.RateId;
    ...
    private void initListeners() {
        ...
        addCommentBtn.setOnClickListener(v -> {
          if (TextUtils.isEmpty(comment.getText().toString())){
                Toast.makeText(getContext(), getString(R.string.enter_comment), Toast.LENGTH_SHORT).show();
                return;
            }
          if(ratingBar.getRating()<=0){
              Toast.makeText(getContext(), getString(R.string.give_rating), Toast.LENGTH_SHORT).show();
              return;
          }
          else {
