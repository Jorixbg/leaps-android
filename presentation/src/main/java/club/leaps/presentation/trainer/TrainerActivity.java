...
import club.leaps.networking.profile.EntityService;
...
import club.leaps.presentation.homefeed.activities.HomeFeedActivitiesPresenter;
import club.leaps.presentation.test.ChatView;
...
public class TrainerActivity extends AppCompatActivity implements IActivity, SwipeRefreshLayout.OnRefreshListener  {
    ...
    private void getUser(){
        ...
        if(trainer!=null){
            ...
            trainerId = trainer2.userId();
        }


        followingService.addHeader("Authorization", PreferenceManager.getDefaultSharedPreferences(this).getString("Authorization", ""));
        followingService.getUser(trainerId)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(userResponse -> {
