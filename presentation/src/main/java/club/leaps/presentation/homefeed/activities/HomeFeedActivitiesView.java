package club.leaps.presentation.homefeed.activities;
...
import club.leaps.presentation.homefeed.FeedInsideTab;
...
import static club.leaps.presentation.event.EventListingActivity.EVENT_NEARBY;
import static club.leaps.presentation.event.EventListingActivity.EVENT_POPULAR;
import static club.leaps.presentation.event.EventListingActivity.EVENT_SUITED;
import static club.leaps.presentation.homefeed.HomeFeedContainer.FEED_SEARCH_EVENT_KEY;
...
public class HomeFeedActivitiesView extends BaseView<HomeFeedActivitiesPresenter> implements FeedInsideTab,SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void addSubscriptions(List<Subscription> subscriptions) {
        subscriptions.add(presenter.getEventsObservable().subscribe(this::onSuccess,this::getEventError));
    ...
    private void getEventError(Throwable t){
