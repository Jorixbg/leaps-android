...
import club.leaps.presentation.homefeed.activities.HomeFeedActivitiesView;
import club.leaps.presentation.homefeed.trainers.FeedTrainersView;
...
import club.leaps.presentation.homefeed.trainers.FeedTrainersView;
import club.leaps.presentation.homescreen.HomeScreenView;
import club.leaps.presentation.map.GoogleMapContainer;
...
public class HomeFeedContainer extends BaseView<EmptyPresenter> implements OnSearchDataCollectedListener {
    ...
    private class HomeFeedPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 1:
                    return getString(R.string.trainer_title);
                case 0:
                default:
                    return getString(R.string.activities_title);
            }
        }
